...
class Game extends Object with Joypad {
  ...
  void start() {
    ...
    // Insert into page
    document.querySelector(this.stage).append(board.generate());

    // TODO: Implement Joypad fully
  ...
  void checkWinner() {
    ...
    _winningCombinations.forEach((List winningCombination) {
      ...
      if (board.cells[winningCombination[0] - 1].token == playerToken && board.cells[winningCombination[1] - 1].token == playerToken && board.cells[winningCombination[2] - 1].token == playerToken) {
